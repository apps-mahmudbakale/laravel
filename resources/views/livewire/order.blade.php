        ...
        <tbody>
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td>{{$order->qty }}</td>
                    <td class="d-none d-xl-table-cell">{{ $order->user->name }}</td>
                    <td class="d-none d-xl-table-cell">{{ $order->order_type }}</td>
                    <td class="d-none d-xl-table-cell">{{$order->created_at->diffForHumans()}}</td>
                    <td class="d-none d-xl-table-cell"><a href="" class="btn btn-outline-danger" wire:click.prevent="selectedProduct({{$order->id}}, 'sell')">Sell</a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
