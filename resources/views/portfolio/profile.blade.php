            ...
            <div class="col-md-4 col-xl-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <img src="{{asset('img/avatars/avatar-4.jpg')}}" alt="Stacie Hall" class="img-fluid rounded-circle mb-2" width="128" height="128" />
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1"><span data-feather="phone" class="feather-sm me-1"></span> Phone <a href="#">{{$user->phone    }}</a></li>

                            <li class="mb-1"><span data-feather="mail" class="feather-sm me-1"></span> Email <a href="#">{{$user->email}}</a></li>
                        </ul>
                    </div>
                    <hr class="my-0" />
                </div>
                        ...
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="icon-tab-3" role="tabpanel">
                                    <x-user-transactions :transactions="$transactions" />
                                </div>
                                <div class="tab-pane" id="icon-tab-4" role="tabpanel">
                                    <h2>Banks</h2>
                                    <x-user-banks :banks="$banks" />
                                </div>
                            </div>
                        </div>
